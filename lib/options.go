...
type Options struct {
	...
	Background struct {
		// Type  Background `desc:"Type of background" default:"Uniform"`
		...
		Image Path   `desc:"Path/URL of image to use as skybox" Type:"Skybox"`
...
type Light struct {
	Type      string `desc:"Directional, Point, Spot"`
...
type Material struct {
	Name         string      `desc:"Unique name for the material" default:"name"`
	Parent       string      `desc:"Name of existing material to inherit attributes from" default:"parent"`
	Emissive     interface{} `desc:"Emissive color of the material" type:"Path,Color"`
	Ambient      interface{} `desc:"Abmient color of the material" type:"Path,Color"`
	Diffuse      interface{} `desc:"Diffuse color of the material" type:"Path,Color"`
	Specular     interface{} `desc:"Specular color of the material" type:"Path,Color"`
	Reflective   interface{} `desc:"Reflectivness of the material" type:"Path,Color"`
	Transmissive interface{} `desc:"Transmissivness of the material" type:"Path,Color"`
	Smoothness   interface{} `desc:"Smoothness of the material. Affects size of speclar spots" type:"Path,float64"`
	Index        float64     `desc:"Refractive index of the material"`
	Normal       Path        `desc:"Path/URL of image to use as a normal map"`
...
type Object struct {
	Type         string   `desc:"Transform, Sphere, Box, Square, Cylinder, Cone"`
	...
	RotateAngle  Degrees  `desc:"Transform angle to rotate around the axis" Type:"Transform"`
...
func NewOptions() *Options {
	...
	opts.Materials = append(opts.Materials, &Material{})
	return opts
}
